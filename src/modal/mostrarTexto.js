...
export const Modal_mostrarTexto = ({info=''}) => {
    console.log(info);
    return (
      <div className="modal fade" id="idModalMostrarTexto" aria-hidden="true" aria-labelledby="idModalDeleteAllLabel2" tabIndex="-1">
